...
**Data Preprocessing**  
Before feeding the data into the neural network, the SOW will be [mean normalized](https://en.wikipedia.org/wiki/Feature_scaling) in an attempt to improve performance.
...
Desired Outputs:
[2, 1, 2, 1, 0, 1, 1, 2, 1, 2]
Network Output after 5000 iterations:
[2, 1, 2, 1, 0, 1, 1, 2, 1, 2]
Network Weights:
